...
Intro
-----
Koinmudra (KMI) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Koinmudra utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run koinmudra-qt.exe.

KoinMudra is the original Koinmudra client and it builds the backbone of the network.
However, it downloads and stores the entire history of Koinmudra transactions;
