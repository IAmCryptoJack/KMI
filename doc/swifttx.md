...
This mechanism has been integrated into Bitcore-Node-Koinmudra which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/KoinMudra/insight-api-koinmudra#web-socket-api](https://github.com/KoinMudra/insight-api-koinmudra#web-socket-api)
* API: [https://github.com/KoinMudra/insight-api-koinmudra#swifttx-transactions](https://github.com/KoinMudra/insight-api-koinmudra#swifttx-transactions)
...
By default, the KoinMudra daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the KoinMudra daemon:
