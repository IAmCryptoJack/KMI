...
// Repair parameters
const QString KOINMUDRAWALLET("-koinmudrawallet");
                                          ...
                                          banTableContextMenu(0)
{
    ...
    connect(ui->btn_koinmudrawallet, SIGNAL(clicked()), this, SLOT(walletKoinmudra()));
...
/** Restart wallet with "-koinmudrawallet" */
void RPCConsole::walletKoinmudra()
{
    buildParameterlist(KOINMUDRAWALLET);
}
...
void RPCConsole::buildParameterlist(QString arg)
{
    ...
    args.removeAll(KOINMUDRAWALLET);
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Koinmudra RPC console.") + "<br>" +
