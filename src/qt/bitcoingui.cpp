                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("KoinMudra") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a KMI address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and koinmudra: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About KoinMudra"), this);
    aboutAction->setStatusTip(tr("Show information about KoinMudra"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Koinmudra"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your KMI addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified KMI addresses"));
    ...
    openAction->setStatusTip(tr("Open a koinmudra: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the KoinMudra help message to get a list with possible Koinmudra command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("KoinMudra client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Koinmudra network", "", count));
}
...
{
    QString strTitle = tr("KoinMudra"); // default title
