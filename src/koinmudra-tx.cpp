...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("KoinMudra koinmudra-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  koinmudra-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded koinmudra transaction") + "\n" +
                               "  koinmudra-tx [options] -create [commands]   " + _("Create hex-encoded koinmudra transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded koinmudra transaction
