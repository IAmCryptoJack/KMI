Contributing to KoinMudra
==================================

The KoinMudra project operates an open contributor model where anyone is
...
The following applies to code changes to the KoinMudra project, and is not to be
confused with overall Koinmudra Network Protocol consensus changes.

Whether a pull request is merged into KoinMudra rests with the project merge
...
Patches that change Koinmudra consensus rules are considerably more involved than
...
Where a patch set proposes to change the Koinmudra consensus, it must have been
...
The project leader is the release manager for each KoinMudra release.
